...
{
  "$end", "error", "$undefined", "P_CNF", "NUM", "ZERO", "EOL", "ERROR",
  "$accept", "input", "problem", "clause_list", "clause", "clause_end",
  "literal_list", YY_NULLPTR
};
#endif
...
{
       0,     0,     0,     3,     0,     1,    14,    10,    11,    12,
       2,     6,     8,     0,     0,     9,     5,    13,     7,     4
};
...
{
       6,     7,     8,     9,    17,     7,     8,     9,     1,     5,
       4,    14,    16,     0,    15,     0,    19,    18
};
...
{
       0,     3,     9,    10,     4,     0,     4,     5,     6,     7,
      11,    12,    13,    14,     4,     6,    12,     4,    13,     6
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_int8 yyr1[] =
{
       0,     8,     9,     9,    10,    11,    11,    12,    12,    13,
      13,    13,    13,    14,    14
};
...
#line 54 "ex1.y"
                            {
        expected_num_vars = (yyvsp[-2].value);
        expected_num_clauses = (yyvsp[-1].value);
        p_cnf_found = 1;
    }
#line 1356 "ex1.tab.c"
    break;
...
#line 87 "ex1.y"
        ...
        char message[50]; 
        sprintf(message, "Unexpected character '%c'", (yyvsp[0].character));
        yyerror(message);
        return 1;
    }
#line 1416 "ex1.tab.c"
...
#line 98 "ex1.y"
                                {
    int var = (yyvsp[0].value);
        if((yyvsp[0].value) > 0){
            int chars_written = sprintf(buffer + pos, " ∨ p%d", (yyvsp[0].value));
            pos += chars_written; 
        }else{
            int chars_written = sprintf(buffer + pos, " ∨ !p%d", -(yyvsp[0].value));
            pos += chars_written;
