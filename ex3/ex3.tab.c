...
{
       0,   139,   139,   140,   143,   144,   148,   149,   150,   154,
...
{
  "$end", "error", "$undefined", "INT", "EXPR_END", "'+'", "'-'", "'*'",
  "'/'", "'%'", "UMINUS", "'('", "')'", "$accept", "input",
  "sentence_list", "sentence", "expr", YY_NULLPTR
};
#endif
...
{
      17,     2,    -5,    -5,    -1,    -1,     3,    26,    -5,    42,
      -5,    -5,    33,    -5,    -5,    -5,    -1,    -1,    -1,    -1,
      -1,    -5,     0,     0,    -5,    -5,    -5
};
...
{
       0,     0,    16,     6,     0,     0,     0,     0,     5,     0,
       8,    15,     0,     1,     4,     7,     0,     0,     0,     0,
       0,    14,     9,    10,    11,    12,    13
};
...
{
      11,    12,     2,    13,    14,     4,    10,    18,    19,    20,
       5,     0,    22,    23,    24,    25,    26,    -3,     1,     0,
       2,     3,     0,     4,     0,     0,    -2,     1,     5,     2,
       3,     0,     4,     0,     0,     0,     0,     5,    16,    17,
      18,    19,    20,     0,     0,    21,    15,    16,    17,    18,
      19,    20
};
...
{
       4,     5,     3,     0,     7,     6,     4,     7,     8,     9,
      11,    -1,    16,    17,    18,    19,    20,     0,     1,    -1,
       3,     4,    -1,     6,    -1,    -1,     0,     1,    11,     3,
       4,    -1,     6,    -1,    -1,    -1,    -1,    11,     5,     6,
...
{
       0,     1,     3,     4,     6,    11,    14,    15,    16,    17,
       4,    17,    17,     0,    16,     4,     5,     6,     7,     8,
       9,    12,    17,    17,    17,    17,    17
};
...
yyreduce:
  ...
  case 7:
#line 149 "ex3.y"
                    { printf("%s\n", expressions[(yyvsp[-1].index)]); clean_arrays();}
#line 1439 "ex3.tab.c"
    break;
...
#line 1446 "ex3.tab.c"
  ...
  case 9:
#line 154 "ex3.y"
                                    { (yyval.index) = num_expr; save_expr((yyvsp[-2].index), (yyvsp[0].index), '+'); }
#line 1452 "ex3.tab.c"
    break;
...
#line 1482 "ex3.tab.c"
  ...
  case 15:
#line 160 "ex3.y"
                                    { (yyval.index) = num_expr; save_unary_expr((yyvsp[0].index), '-'); }
#line 1488 "ex3.tab.c"
    break;

  case 16:
#line 161 "ex3.y"
                                    { (yyval.index) = num_expr; save_num_expr((yyvsp[0].number)); }
#line 1494 "ex3.tab.c"
    break;
