...
#ifndef YY_YY_EX4_TAB_H_INCLUDED
# define YY_YY_EX4_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_EX4_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "VAR", "AND", "OR", "NOT", "IMPLIES",
  "IFF", "EOL", "'('", "')'", "$accept", "input", "formula_list",
  "formula", "proposition", YY_NULLPTR
};
#endif
...
{
      16,    -8,    -9,    28,    -9,    28,     5,    27,    -9,    35,
      -9,    -9,    -1,    -9,    -9,    28,    28,    28,    28,    -9,
      -9,    -9,     7,     4,     4
};
...
{
      11,    10,    12,    15,    16,    13,    17,    18,    15,    16,
      20,    15,    21,    22,    23,    24,    -3,     1,    14,     2,
       0,     0,     3,     0,     0,     4,     5,    -2,     1,     0,
       2,     2,     0,     3,     3,     0,     4,     5,     5,    15,
      16,     0,    17,    18,    19
};
...
{
       3,     9,     5,     4,     5,     0,     7,     8,     4,     5,
      11,     4,    15,    16,    17,    18,     0,     1,     7,     3,
      -1,    -1,     6,    -1,    -1,     9,    10,     0,     1,    -1,
       3,     3,    -1,     6,     6,    -1,     9,    10,    10,     4,
       5,    -1,     7,     8,     9
};
...
{
       0,     1,     3,     6,     9,    10,    13,    14,    15,    16,
       9,    16,    16,     0,    15,     4,     5,     7,     8,     9,
      11,    16,    16,    16,    16
};
...
#line 109 "ex4.y"
                                        { printf("NOT: %s\n", (yyvsp[0].str));
    (yyval.str) = make_unary_proposition((yyvsp[0].str), '!'); }
#line 1413 "ex4.tab.c"
    break;
...
#line 111 "ex4.y"
        ...
        (yyval.str) = make_binary_proposition((yyvsp[-2].str), (yyvsp[0].str), "∧"); }
#line 1420 "ex4.tab.c"
    break;
...
#line 115 "ex4.y"
                                        { printf("IMPLIES: %s %s\n", (yyvsp[-2].str), (yyvsp[0].str));
        (yyval.str) = transform_implies((yyvsp[-2].str), (yyvsp[0].str)); }
#line 1434 "ex4.tab.c"
    break;
...
#line 117 "ex4.y"
                                        { printf("IFF: %s %s\n", (yyvsp[-2].str), (yyvsp[0].str));
        (yyval.str) = transform_iff((yyvsp[-2].str), (yyvsp[0].str)); }
#line 1441 "ex4.tab.c"
    break;
...
#line 119 "ex4.y"
        ...
        (yyval.str) = add_parenthesis((yyvsp[-1].str)); }
#line 1448 "ex4.tab.c"
    break;
...
#line 121 "ex4.y"
                                        { printf("VAR: %c\n", (yyvsp[0].value));
        (yyval.str) = malloc(2 * sizeof(char)); 
                                          sprintf((yyval.str), "%c", (yyvsp[0].value));}
#line 1456 "ex4.tab.c"
    break;
